  ...
  return (
    <div className='flex flex-row gap-3 px-8'> 
      ...
      <div className='flex  flex-col w-full'>
        ...
        <div className="flex flex-col  px-9 py-14 w-[1240px] text-2xl border-solid bg-zinc-900 border-[6px] border-zinc-700 rounded-[30px] max-md:px-5">
          <div className="text-white myfont max-md:max-w-full">Lock Info</div>
          
          <div className="flex gap-5 mt-20 max-md:flex-wrap max-md:mt-10 max-md:max-w-full">
            <div className="flex-auto myfont text-neutral-500">Current Locked Amount</div>
          ...
          <div className="flex gap-5 mt-9 max-md:flex-wrap max-md:max-w-full">
            <div className="flex-auto myfont text-neutral-500">Current Values Locked</div>
          ...
          <div className="flex gap-5 mt-9 max-md:flex-wrap max-md:max-w-full">
            <div className="flex-auto myfont text-neutral-500">Tone Name</div>
            <div className="font-bold text-right text-white">Trade AI</div>
          </div>
          
          <div className="flex gap-5 mt-9 max-md:flex-wrap max-md:max-w-full">
            <div className="flex-auto myfont text-neutral-500">Token Symbol</div>
            <div className="font-bold text-right text-white">wTAI</div>
          </div>
          
          <div className="flex gap-5 mt-9 max-md:flex-wrap max-md:max-w-full">
            <div className="flex-auto myfont text-neutral-500">Token Decimals</div>
            <div className="font-bold text-right text-white">9</div>
          </div>
        </div>
        <div className="flex flex-col  mt-12 px-11 py-14 border-solid bg-zinc-900 border-[6px] border-zinc-700 rounded-[30px] max-md:px-5">
          <div className="text-2xl myfont text-white max-md:max-w-full">Lock Records</div>
          
          <div className="flex gap-5 justify-between items-start mt-6 text-base max-md:flex-wrap max-md:max-w-full">
            <div className="flex flex-col  whitespace-nowrap">
              <div className="font-medium myfont text-neutral-500 text-left">Wallet</div>
              <div className="mt-8 font-semibold text-white">0x6227...FcCB</div>
            </div>
            <div className="flex flex-col text-right whitespace-nowrap">
              <div className="font-medium myfont text-neutral-500 text-left">Amount</div>
              <div className="mt-8 font-semibold text-white">20,000,000</div>
            </div>
            <div className="flex flex-col text-right whitespace-nowrap">
              <div className="font-medium myfont text-neutral-500">Cycle(d)</div>
              <div className="self-center mt-8 font-semibold text-white">-</div>
            </div>
            <div className="flex flex-col text-right">
              <div className="font-medium myfont text-neutral-500">Cycle Realse(%)</div>
              <div className="self-center mt-8 font-semibold text-white">-</div>
            </div>
            <div className="flex flex-col text-right whitespace-nowrap">
              <div className="font-medium myfont text-neutral-500">TGE(%)</div>
              <div className="self-center mt-8 font-semibold text-white">-</div>
            </div>
            <div className="flex flex-col text-right">
