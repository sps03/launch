    ...
    <div className='flex p-8 flex-row gap-3'>
      ...
      <div className="flex gap-3">
        <div className="flex flex-col text-base font-bold leading-8 text-center text-white whitespace-nowrap">
          <div className="justify-center items-center px-4 py-1.5 w-10 h-10 text-sm bg-purple-600 font-medium leading-7 text-center text-white whitespace-nowrap rounded-full border border-solid  border-slate-600 stroke-[1px]">
            1
          </div>
          <img
            loading="lazy"
      ...
      <div className="flex gap-3">
        <div className="justify-center items-center px-4 py-1.5 w-10 h-10 text-sm font-medium leading-7 text-center text-white whitespace-nowrap rounded-full border border-solid bg-slate-600 border-slate-600 stroke-[1px]">
          2
        </div>
      ...
      <div className="flex gap-3 self-start whitespace-nowrap">
        <div className="justify-center items-center px-4 py-1.5 w-10 h-10 text-sm font-medium leading-7 text-center text-white rounded-full border border-solid bg-slate-600 border-slate-600 stroke-[1px]">
          4
        </div>
