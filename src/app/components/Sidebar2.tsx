...
const Sidebar2 = () => {
  ...
  const toggleDropdownAir = () => {
    setDropdownOpenAir(!dropdownOpenAir);
  };
    ...
    <div>
      ...
      <div className="flex gap-2.5 ">
        ...
        <img
          ...
          className="shrink-0 self-start mt-3.5 aspect-[0.52]"
        />
        </button>
      </div>
      <div className="flex flex-col justify-between self-center items-start py-3.5 mt-11 w-full text-sm font-bold leading-4 text-white whitespace-nowrap hover:bg-purple-600 rounded-[110px]">
        <div className="flex gap-2.5">
          <img
            loading="lazy"
      ...
      <div className="flex gap-5 justify-between self-center mt-7 max-w-full text-sm leading-4 text-white hover:bg-purple-600 hover:py-3  rounded-[110px] whitespace-nowrap w-[175px]">
        <div className="flex gap-2.5">
          <img
            loading="lazy"
      ...
      {dropdownOpen && (
            <div className="relative top-full text-sm text-start left-0 bg-zinc-900 text-white p-2">
              <a href="/launchpad" className="block py-2 px-3 hover:text-purple-600">Create Launchpad</a>
              <a href="/fairlaunch" className="block py-2 px-3 hover:text-purple-600">Create fair launch</a>
              <a href="/dutch" className="block py-2 px-3 hover:text-purple-600">Create dutch auctio</a>
              <a href="#" className="block py-2 px-3 hover:text-purple-600">Create subscript</a>
              <a href="#" className="block py-2 px-3 hover:text-purple-600">Create token</a>
              <a href="/launchpadlist" className="block py-2 px-3 hover:text-purple-600">Launchpad list</a>
            </div>
          )}
      </div>
      ...
      <div className="flex gap-5 justify-between self-center mt-10 max-w-full text-sm leading-4 text-white  hover:bg-purple-600 hover:py-3 rounded-[110px] whitespace-nowrap w-[175px]">
        <div className="flex gap-2.5">
          <img
            loading="lazy"
            ...
            className="shrink-0 w-6 aspect-square"
          />
          <a href='/airdrop' className="my-auto text-left"  >Airdrop</a>
        </div>
        <button>
        <img
          loading="lazy"
          src="https://cdn.builder.io/api/v1/image/assets/TEMP/9e1b2c243a8324653b206d7be26e045789365082c9a0ced7b44e00c60d4cd25e?apiKey=fc314cf36d364dbdb6a0cce0fe9d0082&"
          className="shrink-0 my-auto w-5 aspect-square"
          onClick={toggleDropdownAir}
        />
        </button>
      </div>
      {dropdownOpenAir && (
            <div className="relative top-full text-sm text-start left-0 bg-zinc-900 text-white p-2">
              <a href="/launchpad" className="block py-2 px-3 hover:text-purple-600">Create Airdrop</a>
              <a href="/fairlaunch" className="block py-2 px-3 hover:text-purple-600">Create fair launch</a>
            </div>
          )}
      <div className="flex gap-5 justify-between self-center mt-10 max-w-full text-sm leading-4 hover:bg-purple-600 hover:py-3 rounded-[110px] text-white whitespace-nowrap w-[175px]">
        <div className="flex gap-2.5">
          <img
            loading="lazy"
      ...
      <div className="flex flex-row justify-start gap-2.5 cursor-pointer items-start  py-3.5 mt-6 w-full text-sm  leading-4 text-white whitespace-nowrap hover:bg-purple-600 rounded-[110px]">
        <img
          loading="lazy"
      ...
      <div className="flex flex-row justify-start gap-2.5 cursor-pointer items-start  py-3.5 mt-4 w-full text-sm  leading-4 text-white whitespace-nowrap hover:bg-purple-600 rounded-[110px]">
        <img
          loading="lazy"
          ...
          className="shrink-0 w-6 aspect-square"
        />
        <a href='/' className="my-auto">Buy Crypto Fiat</a>
      </div>
      <div className="flex flex-row justify-start gap-2.5 cursor-pointer items-start  py-3.5 mt-4 w-full text-sm leading-4 text-white whitespace-nowrap hover:bg-purple-600 rounded-[110px]">
        <img
          loading="lazy"
          ...
          className="shrink-0 w-6 aspect-square"
        />
        <a href='/' className="my-auto">Bridge</a>
      </div>
      <div className="flex flex-row justify-start gap-2.5 cursor-pointer items-start  py-3.5 mt-4 w-full text-sm  leading-4 text-white whitespace-nowrap hover:bg-purple-600 rounded-[110px]">
        <img
          loading="lazy"
