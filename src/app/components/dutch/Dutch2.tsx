  ...
  return (
    <div className='flex p-8 flex-row gap-3'>
      ...
      <div className="self-start mt-1.5 flex-auto px-12 text-base text-zinc-700">
        ...
        <div>
          <img src="/vectorstand.png" alt="" className='px-8 py-8'/>
        ...
        <div className="flex flex-col  grow mt-4 max-md:mt-10 max-md:max-w-full">
          ...
          <div className="flex gap-5 justify-between mt-7 max-md:flex-wrap max-md:max-w-full">
            <div className="text-xl leading-4  myfont text-white">Name</div>
            <div className="text-base font-semibold leading-4 text-right text-purple-500">
              Token Launch
            </div>
          </div>
          <img src="/vectorform.png" alt="" className='py-5' />
          <div className="flex gap-5 justify-between  max-md:flex-wrap max-md:max-w-full">
            <div className="text-xl leading-4 myfont text-white">Symbol</div>
            <div className="text-base font-semibold leading-4 text-right text-white">
              Token 
            </div>
          </div>
          <img src="/vectorform.png" alt="" className='py-5' />
          <div className="flex gap-5 justify-between  max-md:flex-wrap max-md:max-w-full">
            <div className="text-xl leading-4 myfont text-white">Decimals</div>
            <div className="text-base font-semibold leading-4 text-right text-white">
              18
            </div>
          </div>
          <img src="/vectorform.png" alt="" className='py-5' />
          <div className="flex gap-5 justify-between  max-md:flex-wrap max-md:max-w-full">
            <div className="text-xl leading-4 myfont text-white">Balance</div>
            <div className="text-base font-semibold leading-4 text-right text-purple-500">
              10000
            </div>
          </div>
          ...
          <div className="flex gap-4 mt-11 text-white max-md:flex-wrap max-md:mt-10">
            <div className="flex flex-col">
              ...
              <a href='' className="justify-center px-5 py-7 mt-4 text-s font-semibold leading-4 border border-solid border-zinc-700 rounded-[50px]">
            ...
            <div className="flex flex-col grow shrink-0 basis-0 w-fit max-md:max-w-full">
              ...
              <div className="flex gap-4 px-px mt-4 text-sm font-semibold leading-4 max-md:flex-wrap">
